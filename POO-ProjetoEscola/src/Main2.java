...
//        userFile.add("Marina", "lara.marina@pucpr.br", 31);
        ...
        int idade = 0;
            ...
            try {
                ...
                System.out.println("ERRO!!INSERIU UM NUMERO!!");
            ...
            Escola esc = getEscola(nome1, idade);
    ...
    public static @NotNull Escola getEscola(String nome1, int idade) {
        System.out.println("-----INICIO GET ESCOLA --------");
        ...
        esc.setAluno(new Aluno(nome1, idade));
        System.out.println("-----");
        esc.getNome();
        System.out.println("-----");
        Endereco reco = new Endereco("WESPHALLER,550","NOVA YORK","BAHIA");
        esc.setEndereco(reco);
        System.out.println("VOU PRINTAR AQUI UM ENDEREÇO:");
        esc.getEndereco();
        System.out.println("FIM DO PRINT");
        System.out.println("-------FIM GET ESCOLA---------");
        return esc;
    }
}